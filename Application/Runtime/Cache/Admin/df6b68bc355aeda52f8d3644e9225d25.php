  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select class="form-control1" name="phone">
											...
											<?php if(is_array($users)): foreach($users as $key=>$v): ?><option value="<?php echo ($v["tel"]); ?>"><?php echo ($v["tel"]); ?>---<?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
										</select>
									</div>
								</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">信息内容</label>
									<div class="col-sm-8">
										<input type="text" name="message"  style="height: 100px;" value="" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
