  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
								<!--<div class="form-group">-->
									...
									<!--<div class="col-sm-8">-->
										<!--<select style="width: 350px" name="user">-->
											...
											<!--<?php if(is_array($users)): foreach($users as $key=>$v): ?>-->
								...
								<!--</div>-->
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">输入用户电话</label>
									<div class="col-sm-8">
										<input type="text" name="user" value="" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">充值数量</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">充值密码</label>
									<div class="col-sm-8">
										<input type="password" name="pwd" value="" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
