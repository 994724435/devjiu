		    ...
		    <table class="table">
		      <thead>
		        <tr style="text-align: center;">
		           <h3> <span><a href="/devjiu/index.php/Admin/Index/addproduct">添加产品</a></h3>
		        </tr>
		        <tr>
		          <th>编号</th>
					<th>名称</th>
		      ...
		      <?php if(is_array($res)): foreach($res as $key=>$v): if(($i%2)==1){ echo "<tr class='active'>"; }else{ echo "<tr class='info'>"; } ?>
		          ...
		          <th style="width: 200px"><?php echo ($v["cont"]); ?></th>
				  ...
				  <th><a href="/devjiu/index.php/Admin/Index/editeproduct/id/<?php echo ($v["id"]); ?>">修改</a>|<?php if($v["state"] == 1): ?><a href="javascript:if(confirm('确认下架吗?'))window.location='/devjiu/index.php/Admin/Index/deleteproduct/id/<?php echo ($v["id"]); ?>'">下 架</a><?php elseif($v["state"] == 2): ?><a href="javascript:if(confirm('确认上架吗?'))window.location='/devjiu/index.php/Admin/Index/deleteproduct/id/<?php echo ($v["id"]); ?>'">上 架</a><?php endif; ?> </th>
		        </tr>
