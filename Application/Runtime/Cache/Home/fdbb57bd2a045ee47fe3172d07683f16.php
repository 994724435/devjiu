...
<body class="bodyColor">
	...
	<div class="mui-content">
        <div class="codeTIP">我的MIF币<span><?php echo ($count); ?></span>个</div>
		<form class="mui-input-group" method="post"  enctype="multipart/form-data">
		     <div class="mui-input-row" >
		        <label class="labelWidth">购买MIF币</label>
		       <input type="number" name="num" class="mui-input-clear inputWidth" placeholder="数量">
		    </div>
		   <div class="codeTIP">每个MIF币价值<?php echo ($config["value"]); ?>积分，每次至少购买1或整数</div>
