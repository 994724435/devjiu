...
<head>
	...
	<link rel="stylesheet" href="/mifnew/Public/Home/css/style.css">
	<link rel="stylesheet" href="/mifnew/Public/Home/css/amazeui.min.css">
	<link rel="stylesheet" href="/mifnew/Public/Home/css/app.css">
</head>
<body>
<div class="am-g myapp-login">
	<div class="myapp-login-bg">
		<div class="myapp-login-logo">
			<img src="/mifnew/Public/Home/images/logo.gif" alt="" class="logoI">
		</div>
