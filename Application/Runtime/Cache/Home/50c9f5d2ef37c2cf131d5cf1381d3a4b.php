...
<head>
	...
	<title>登录</title>
	<style type="text/css">
		body{background: url('/dev/devjiu/Public/Home/img/logoBg.jpg') repeat-y;background-size: 100% auto;}
		...
		.loginBtn{width: 150px;height: 45px;line-height: 45px;
			background: url('/dev/devjiu/Public/Home/img/btn.png') no-repeat;background-size: 100% 100%;text-align: center;border:none;color: #fff;
			display: block;margin:20px  auto 0;}

	</style>
</head>
<body>
<img src="/dev/devjiu/Public/Home/img/logo.png" alt="" class="logoImg">
<form action=""  method="post"  enctype="multipart/form-data">
	<ul  class="loginDiv">
		...
		<li><span>验证码</span><input type="text" name="number" placeholder="输入验证码"><div><?php echo ($numbers); ?></div></li>
